...
export default function CustomersPage() {
  ...
  async function create(event: React.FormEvent) {
    ...
    try { await api.createCustomer(form); setForm(empty); setDialog(false); await load(); }
  ...
  return <DataPageShell active="/customers"><motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .28 }}>
    <div className="page-heading"><div><span className="eyebrow">Relacionamentos</span><h1>Clientes</h1><p>Organize os clientes associados às suas operações.</p></div><Button onClick={() => setDialog(true)}><Plus size={16} /> Novo cliente</Button></div>
